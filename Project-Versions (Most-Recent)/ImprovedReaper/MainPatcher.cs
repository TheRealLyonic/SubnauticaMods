...
namespace ImprovedReaper
{
    ...
    public class MainPatcher : MonoBehaviour
    {
        ...
        public class Config : ConfigFile
		{
            ...
            //Slider for the multiple at which to increase the reaper's size.
            [Slider("Reaper Size Multiplier", Format = "{0:F2}", Min = 1.0f, Max = 5.0f, DefaultValue = 3.0f, Step = 1f)]
            public float reaperSizeMultiplier = 3.0f;

            //Slider for the multiple at which to increase the reaper's sensitivity to sound.
            [Slider("Reaper Sensitivity Multiplier", Format = "{0:F2}", Min = 1.0f, Max = 5.0f, DefaultValue = 3.0f, Step = 0.5f)]
            public float reaperHSMultiplier = 3.0f;
		}
